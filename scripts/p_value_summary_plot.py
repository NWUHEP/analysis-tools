...
from nllfitter.plot_tools import set_new_tdr, make_directory
...
if __name__ == '__main__':
    ...
    xlimits    = (12., 70.)
    period     = 2012
    output_path = 'plots/fits/{0}'.format(period)
    model      = 'Gaussian'
    ...
    if ndim == 1:
        ...
        for channel in channels:
            ...
            ft.plot_pvalue_scan_2D(qscan, x, y, 
                                   path='{0}/pvalue_scans_{1}_{2}_2D.pdf'.format(output_path, channel, model))
