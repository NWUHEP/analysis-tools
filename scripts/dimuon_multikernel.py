...
if __name__ == '__main__':
    ...
    sig_params.add_many(
                        ...
                        ('A3'     , 0.01 , True , 0.0 , 1.   , None),
                        ('m_jpsi' , -0.43 , True , -0.4 , -0.45  , None),
                        ('gamma_jpsi' , 0.04 , True , 0.03 , 0.05  , None)
                        ('m_upsilon'    , -0.43 , True , -0.4 , -0.45  , None),
                        ('gamma_upsilon' , 0.04 , True , 0.03 , 0.05  , None)
